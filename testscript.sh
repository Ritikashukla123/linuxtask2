...
sudo mysql -u root -pR123456@s << EOF
...
sudo mysqldump -u root -pR123456@s test > /home/ritikashukla/task1/test.sql 

# Create tar file of backup and store it in /tmp directory
tar czf /tmp/$filename /home/ritikashukla/task1/test.sql 